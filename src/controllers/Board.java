...
public class Board {
     ...
     * 
     * @param squares Creates a new ArrayList of type Square
     * @param players Creates a new ArrayList of type Player
     * @param hareCards Creates a new ArrayList of type String
     * @param turnCounter An int which gets increased at the end of each players turn
     * @param numberOfPlayersFinished An int which keeps track of players who have finished the game
     * @param hareCardDeck An int which keeps track of the position of hareCards in the ArrayList 
     */
    public Board() {
    ...
    /**
     *Populates the hareCards ArrayList with object of type String
     *
     */
    ...
    /**
     *Method to return specific hareCard based on a given idex
     * @param index
     * @return hareCard from the ArrayList by index number
     */
    ...
    /**
     *Method to create the Board for the board game
    ...
    /**
     *Method to return Square from the squares Arraylist based on a given index
     * 
     * @param index
    ...
    /**
     *Method which has to be removed before final version
     *
     */
    ...
    /**
     *Method which returns a first hare care in the ArrayList
    ...
    /**
     *Method which returns the amount of players who have finished the game
     *
