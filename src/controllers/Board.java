...
public class Board
{
	...
	private static int turnCounter, numberOfPlayersFinished, hareCardDeck;
	private static boolean gameInProgress, turnComplete, firstLaunch;
    ...
    public void load() throws Exception
    {
    	...
    	squares = (ArrayList<Square>) is.readObject();
